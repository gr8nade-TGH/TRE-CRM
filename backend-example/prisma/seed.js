...
async function main() {
  ...
  // Create some closed leads for history
  const closedLeads = await Promise.all([
    prisma.lead.create({
      data: {
        id: 'closed_lead_1',
        name: 'Closed Lead 1',
        ...
        prefs: {
          ...
          credit_tier: 'A',
          background: 'None',
          notes: 'Successfully closed lead'
        }
      }
    }),
    prisma.lead.create({
      data: {
        ...
        prefs: {
          ...
          credit_tier: 'B',
          background: 'None',
          notes: 'Another successfully closed lead'
        }
      }
    })
  ]);

  console.log('✅ Created closed leads');
