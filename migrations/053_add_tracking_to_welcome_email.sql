-- Migration 053: Add Tracking to Welcome Email Template
-- Purpose: Add tracking pixel and click tracking to welcome email
-- - Tracking pixel for open tracking
-- - Wrapped CTAs with click tracking URLs

-- ============================================
-- UPDATE WELCOME EMAIL TEMPLATE WITH TRACKING
-- ============================================
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="agent-card">
                ...
                <div class="agent-detail">
                    📧 Email: <a href="{{trackingUrl_agent_email}}">{{agentEmail}}</a>
                </div>
                <div class="agent-detail">
                    📱 Phone: <a href="{{trackingUrl_agent_phone}}">{{agentPhone}}</a>
                </div>
            </div>
            ...
            <p style="text-align: center; margin: 32px 0;">
                <a href="{{trackingUrl_cta_button}}" class="cta-button">
                    📧 Contact Your Agent
                </a>
            </p>
