-- ============================================================================
-- MIGRATION 003: Activity Logging System
-- ============================================================================
-- Purpose: Create comprehensive activity logging for leads and properties
-- Date: 2025-10-18
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.lead_activities (
    ...
    -- Types: 'created', 'assigned', 'health_changed', 'note_added', 'updated', 
    --        'showcase_sent', 'showcase_responded', 'email_sent', 'call_logged'
...
CREATE TABLE IF NOT EXISTS public.property_activities (
    ...
    activity_type VARCHAR NOT NULL,
    -- Types: 'created', 'updated', 'note_added', 'pumi_changed', 'pricing_updated', 'deleted'
...
-- Function to automatically log lead updates
...
-- Function to automatically log property updates
...
-- ============================================================================
-- 5. ENABLE REALTIME (Optional - for live activity updates)
-- ============================================================================
...
-- 2. Add API functions to create activity logs
-- 3. Create UI components to display activity logs
